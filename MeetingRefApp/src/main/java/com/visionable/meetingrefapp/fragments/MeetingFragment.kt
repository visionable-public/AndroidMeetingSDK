...
class MeetingFragment : Fragment(), INotificationCallback {
    ...
    // Device Lists
    private var audioInputDevices: Array<String> = arrayOf()
    private var audioOutputDevices: Array<String> = arrayOf()
    private var videoDevices: Array<String> = arrayOf()
    ...
    private fun setupNetworkCameraBottomSheet() {
        ...
        with (binding.networkCameraManagerLayout) {
            ...
            addNetworkCameraButton.setOnClickListener {
                ...
                if (MeetingSDK.enableNetworkVideo(newNetworkCameraURL, MeetingSDK.VP8_LARGE_NAME)) {
                    // Add new camera item
    ...
    override fun participantAdded(p0: Participant?) {
        p0?.let { participant ->
            ...
            if (!participant.isLocal && participant !in participantList) {
                ...
                MeetingSDK.setAudioStreamVolume(participant.audioStreamId, STD_VOLUME)
