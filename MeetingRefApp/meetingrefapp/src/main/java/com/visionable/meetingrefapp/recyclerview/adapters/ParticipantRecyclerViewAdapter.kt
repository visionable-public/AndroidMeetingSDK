...
class ParticipantRecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: ParticipantRecyclerViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            getNameAbbreviation(displayName)?.let { abbvName ->
                if (abbvName.isNotBlank()) participantAbbvName.text = abbvName
            }

            participantName.text = displayName

            // todo provide isMuted function into AudioInfo
//            toggleAudioIcon.isChecked = !participant.audioInfo.isMuted
            ...
            participantVolumeSlider.apply {
                ...
                addOnSliderTouchListener(object : Slider.OnSliderTouchListener {
                    ...
                    override fun onStopTrackingTouch(slider: Slider) {
                        setAudioStreamVolume(participant.audioInfo.streamId, slider.value.toInt())
                    }
                })
